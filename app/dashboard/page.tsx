...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const checkSession = async () => {
      try {
        // Use fetch to get session data from an API endpoint instead of direct MongoDB access
  ...
  return (
    <div className="py-8 bg-stone-50 dark:bg-gray-900/40 min-h-screen">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <DemoToggle title="Dashboard Overview">
          {/* Stats Overview */}
        ...
        <DemoToggle title="Dashboard Cards">
